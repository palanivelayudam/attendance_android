...
public class OnboardingPageTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            // Fragment 1 -- Settings
            final View tv_settings_title = page.findViewById(R.id.textView);
            if (tv_settings_title != null) tv_settings_title.setAlpha(1.0f - absPosition * 2);

            final View tv_settings_title1 = page.findViewById(R.id.floatingActionButton);
            if (tv_settings_title1 != null) tv_settings_title1.setAlpha(1.0f - absPosition * 2);

            final View tv_settings_title2 = page.findViewById(R.id.button);
            if (tv_settings_title2 != null) tv_settings_title2.setAlpha(1.0f - absPosition * 2);

           /* final View tv_brightness = page.findViewById(R.id.floatingActionButton);
            if (tv_brightness != null) tv_brightness.setTranslationX(pageWidthTimesPosition * 0.5f);
//
            final View sb_brightness = page.findViewById(R.id.button);
...
//            if (sb_size != null) sb_size.setTranslationX(pageWidthTimesPosition * 1.2f);
            ...
            final View tv_background = page.findViewById(R.id.tvcontent);
...
//            if (tv_profile_title != null) tv_profile_title.setAlpha(1.0f - absPosition * 2);
           ...
           /* final ImageView profile = (ImageView) page.findViewById(R.id.imageView);
...
//            final View tv_feature_title = page.findViewById(R.id.button);
//            if (tv_feature_title != null) tv_feature_title.setAlpha(1.0f - absPosition * 2);

           /* final View bike = page.findViewById(R.id.tvcontent);
            if (bike != null) {
            ...
            final View bike_shadow = page.findViewById(R.id.imageView);
            if (bike_shadow != null) {
